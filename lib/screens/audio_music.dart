...
class AudioMusicScreen extends StatefulWidget {
  const AudioMusicScreen({Key? key}) : super(key: key);

  @override
  State<AudioMusicScreen> createState() => _AudioMusicScreenState();
}
                  ...
                  child: Column(
                    children: [
                      Row(
                        ...
                        children: [
                          Text("AUDIO",style: TextStyle(color: Colors.deepOrange,fontSize: 25),),
                          Container(
                                                            ...
                                                            Row(
                                                              ...
                                                              children: [
                                                                ...
                                                                ElevatedButton(onPressed: (){
                                                                  Get.to(()=>AudioPlayerScreen(i));
                                                                }, child: Text("Play",style: TextStyle(color: Colors.white),),style: ButtonStyle(backgroundColor: MaterialStateProperty.all(Colors.orange)),)
                                                              ],
                                                            ),
                                                          ],
                                                        ),
                                          ...
                                          child: ListView.builder(
                                            ...
                                            itemBuilder: (context,int index){
                                              return GestureDetector(
                                                onTap: (){},//()=>Get.to(()=>/*AudioPlayerScreen(snapshot.data[index])*/),
                                                child: Container(
                                                      ...
                                                      Container(
                                                        ...
                                                        child: Column(
                                                          ...
                                                          children: [
                                                            ...
                                                            Text("100 views",style: TextStyle(fontSize: 10,color:Colors.orange),maxLines: 1,overflow: TextOverflow.ellipsis,)
                                                          ],
                                                        ),
                                                      ),
                                                    ],
