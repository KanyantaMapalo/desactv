...
class _MoviesScreenState extends State<MoviesScreen> {
  ...
  Widget build(BuildContext context) {
    shortMovies()async{
      short_movies = await dbops.fetchShortMovies();
      print("ARE YOU PRINTING ME? "+short_movies.toString());
    }
    shortMovies();
    return Scaffold(
      body: Container(
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        Row(
                          children: [
                            Text("MOVIES",style: TextStyle(color: Colors.deepOrange,fontSize: 25),),
                            Container(
                       ...
                       child: Column(
                         children: [
                                     ...
                                     return     Column(
                                       children: [
                                         Row(
                                           mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                           children: [
                                             Container(padding:EdgeInsets.only(left:18),child: Text("Drama",style: TextStyle(color: Colors.teal, fontWeight: FontWeight.bold),)),
                                             TextButton(onPressed: (){Get.to(()=>ViewAll("drama"));}, child: Row(children: [Text("view all"),Icon(Icons.arrow_right_alt)],))
                                           ],
                                         ),
                                         Container(
                                     ...
                                     return     Column(
                                       children: [
                                         Row(
                                           mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                           children: [
                                             Container(padding:EdgeInsets.only(left:18),child: Text("Short Film",style: TextStyle(color: Colors.teal, fontWeight: FontWeight.bold),)),
                                             TextButton(onPressed: (){Get.to(()=>ViewAll("short film"));}, child: Row(children: [Text("view all"),Icon(Icons.arrow_right_alt)],))
                                           ],
                                         ),
                                         Container(
                                           /* margin: EdgeInsets.symmetric(horizontal:20),*/
                           ...
                           Container(
                               ...
                               child: FutureBuilder(
                                 future: dbops.fetchTrailerMovies(),
                                 builder: (BuildContext context,AsyncSnapshot snapshot){
                                   if(snapshot.data!=null){
                                     return Column(
                                       children: [
                                         Row(
                                           mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                           children: [
                                             Container(padding:EdgeInsets.only(left:18),child: Text("Trailer",style: TextStyle(color: Colors.teal, fontWeight: FontWeight.bold),)),
                                             TextButton(onPressed: (){Get.to(()=>ViewAll("trailer"));}, child: Row(children: [Text("view all"),Icon(Icons.arrow_right_alt)],))
                                           ],
                                         ),
                                         Container(
                                           height: 120,
